...
final List<EmojiModel> reactions = <EmojiModel>[
  EmojiModel(
      label: 'Terrible', src: 'mood/angry.png', activeSrc: 'mood/angry.gif'),
  EmojiModel(label: 'Bad', src: 'mood/annoy.gif', activeSrc: 'mood/annoy.gif'),
  EmojiModel(label: 'OK', src: 'mood/cry.png', activeSrc: 'mood/cry.gif'),
  EmojiModel(label: 'Good', src: 'mood/haha.png', activeSrc: 'mood/haha.gif'),
  EmojiModel(
      label: 'Awesome', src: 'mood/horny.png', activeSrc: 'mood/horny.gif'),
].toList();
...
class EmojiSlider extends StatefulWidget {
  ...
  @override
  EmojiSliderState createState() {
    return new EmojiSliderState();
  }
}

class EmojiSliderState extends State<EmojiSlider>
    with SingleTickerProviderStateMixin {
  AnimationController controller;
  Animation<double> animation;
  double pos = 3.0; // should be between [0, 4]
